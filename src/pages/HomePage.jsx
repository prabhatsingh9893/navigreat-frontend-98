  ...
  return (
    <PageTransition className="pt-0"> {/* Wrapper for Global Transition */}
      <div className="font-sans bg-slate-50 min-h-screen">
        {/* 1. HERO SECTION (Premium Gradient & Animations) */}
        <section className="relative pt-32 pb-24 overflow-hidden bg-white">
          {/* Background Gradients */}
          <div className="absolute top-0 inset-x-0 h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-100/50 via-slate-50 to-white -z-10" />
          <div className="absolute top-20 left-10 w-72 h-72 bg-purple-200/30 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-200/30 rounded-full blur-3xl animate-pulse delay-1000" />
            ...
            >
              ...
              <div className="md:w-1/2 text-center md:text-left space-y-8">
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  ...
                  <Link to="/become-mentor" className="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-xl font-bold hover:bg-slate-50 transition-all hover:border-slate-300">
                    Become a Mentor
                  </Link>
                </motion.div>
                ...
                <div className="relative">
                  ...
                  >
                    <img
                      ...
                      alt="Happy Students"
                      className="rounded-3xl shadow-2xl border-4 border-white w-full max-w-md"
                    />
                  </motion.div>
